...
export const flagTypes: BestPractice[] = [
  {
    ...
    title: 'Release Flags',
    description:
      'Use for gradual feature rollouts to users. These flags allow you to progressively expose new functionality, starting with internal teams, then beta users, and finally all users. Release flags should have a limited lifetime and be removed after full rollout.',
  ...
  },
  {
    ...
    description:
      'Use for A/B tests and experiments where you need to measure impact. These flags are temporary and should be removed once the experiment concludes and a winner is chosen.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/feature-flag-types#experiment-toggles',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use for system behavior and operational concerns. These flags control technical aspects like caching strategies, database connection pooling, or feature degradation under load. They may be long-lived.',
  ...
  },
  {
    ...
    description:
      'Use for emergency shutdowns or circuit breakers. These flags allow you to quickly disable problematic features in production without deploying code. Should be tested regularly.',
  ...
  },
  {
    ...
    description:
      'Use for role-based access control and entitlements. These flags control who can access specific features based on user attributes, subscription tiers, or permissions.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/feature-flag-types#permission-toggles',
    examples: [
...
export const lifecycle: BestPractice[] = [
  {
    ...
    description:
      'Feature flags should be temporary by default. Release and experiment flags must have a planned removal date. The longer a flag exists, the more technical debt it creates. Set up reminders or automated checks to remove flags after successful rollout.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#limit-the-lifespan-of-feature-flags',
    examples: [
  ...
  },
  {
    ...
    description:
      'Every flag should have a clear owner who is responsible for its lifecycle. The owner decides when to enable, disable, or remove the flag. Without clear ownership, flags become orphaned and create technical debt.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#assign-ownership-of-feature-flags',
    examples: [
  ...
  },
  {
    ...
    description:
      'Flag descriptions should clearly explain what the flag controls, why it exists, what the rollout plan is, and when it should be removed. Good documentation prevents confusion and helps with cleanup.',
    docsUrl:
  ...
  },
  {
    ...
    description:
      'Remove flags after successful rollout to avoid flag sprawl. Each flag adds complexity to your codebase. Schedule regular flag cleanup sessions. Treat flag removal as part of the feature development process, not an afterthought.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#remove-flags-when-theyre-no-longer-needed',
  },
];
...
export const rollout: BestPractice[] = [
  {
    ...
    description:
      'Roll out changes gradually to minimize risk. Start with development/staging environments, then internal users, then a small percentage of production users, gradually increasing to 100%. This allows you to catch issues before they affect all users.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#use-gradual-rollouts',
    examples: [
  ...
  },
  {
    ...
    description:
      'Use environment-based strategies to enable features in non-production environments first. This allows thorough testing before any production exposure.',
  ...
  },
  {
    ...
    description:
      'Use percentage-based rollout (canary deployment) in production to expose changes to a small subset of users first. Monitor metrics and error rates before expanding.',
  ...
  },
  {
    ...
    description:
      'Always monitor key metrics during rollout. Use impression data to track flag evaluations. Set up alerts for error rates, performance degradation, or unexpected behavior. Be ready to disable the flag if issues arise.',
...
export const antiPatterns: BestPractice[] = [
  {
    ...
    title: 'Flag Sprawl',
    description:
      'Creating too many flags without cleaning up old ones leads to an unmaintainable codebase. Every flag adds conditional complexity. Reuse existing flags when possible instead of creating new ones for minor variations.',
    docsUrl:
      'https://docs.getunleash.io/topics/feature-flags/best-practices-using-feature-flags-at-scale#avoid-flag-sprawl',
    examples: [
  ...
  },
  {
    ...
    description:
      'Avoid nesting flags inside other flags. If code is already protected by a parent flag, adding another flag creates unnecessary complexity and makes rollout logic hard to reason about.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Release flags should be temporary. If a flag has been enabled at 100% for weeks or months, it should be removed. Long-lived flags indicate incomplete work or fear of removing code.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Not every change needs a feature flag. Small, low-risk changes (bug fixes, typos, config tweaks, refactors) can be deployed directly. Reserve flags for risky changes, new features, or changes requiring gradual rollout.',
    examples: [
  ...
  },
  {
    ...
    description:
      'Flag names like "flag1", "test", or "new-feature" provide no context. Use descriptive names that explain what the flag controls. Good names make the codebase self-documenting.',
    examples: [
...
export function getAntiPatternWarnings(): string {
  return antiPatterns
    .map((practice) => `⚠️ **${practice.title}**: ${practice.description}`)
    .join('\n\n');
}
